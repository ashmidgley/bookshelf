          ...
          <div className="card-content">
            ...
            <Formik
              initialValues={{
                ...
                passwordResetToken: this.state.user
                  ? this.state.user.passwordResetToken
                  : null,
                passwordResetExpiry: this.state.user
                  ? moment(this.state.user.passwordResetExpiry).format(
                      "YYYY-MM-DD"
                    )
                  : null,
              }}
