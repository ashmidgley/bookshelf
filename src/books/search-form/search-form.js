...
class SearchForm extends React.Component {
  constructor(props) {
    ...
    this.searchDisabled = this.searchDisabled.bind(this);
    this.authorChecked = this.authorChecked.bind(this);
    this.titleChecked = this.titleChecked.bind(this);
    this.bookSelected = this.bookSelected.bind(this);
    this.handleError = this.handleError.bind(this);
    this.handleSuccess = this.handleSuccess.bind(this);
    this.searchBooks = this.searchBooks.bind(this);
    this.searchBooksByAuthor = this.searchBooksByAuthor.bind(this);
    this.searchBooksByTitle = this.searchBooksByTitle.bind(this);
  ...
  searchDisabled(title, author) {
    if (
      (!this.state.titleChecked && !this.state.authorChecked) ||
                    ...
                    <div className="field">
                      ...
                      <div className="control">
                        <input
                          ...
                          disabled={!this.state.titleChecked}
                        />
                        <input
                          type="checkbox"
                    ...
                    <div className="field">
                      ...
                      <div className="control">
                        <input
                          ...
                          disabled={!this.state.authorChecked}
                        />
                        <input
                          type="checkbox"
